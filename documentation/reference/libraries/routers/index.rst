...
The :doc:`/documentation/reference/libraries/core/index` library, along with the :doc:`/documentation/reference/libraries/types/index` and :doc:`/documentation/reference/libraries/optics/index` libraries, allow for the creation of powerful handlers for HTTP requests, but they don't provide support for routing requests to specific handlers.
